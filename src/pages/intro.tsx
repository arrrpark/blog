...
export default function Intro() {
    return (<Container>
        <SemiTitle style={{ paddingTop: 0 }}>Welcome to my data science projects portfolio!</SemiTitle>
        <DefaultDiv style={{ paddingTop: 40 }}>💻 My nickname is Arrr, a mobile developer from South Korea. I'm current based in United Kingdom.</DefaultDiv>
        <DefaultDiv>🦾 I have 5 years of working experience in mobile devleopment.
            While I was working, I noticed that features I have to implement in a mobile app is heavily decided by data.
            These projects came from my motive to learn data.</DefaultDiv>
        <DefaultDiv>💡 I'm always eager to learn new things, enjoying challenges.</DefaultDiv>
