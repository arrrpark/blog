...
export default function Bike() {
  return (
    <Container>
      <BigTitle>
        Data visualization and prediction on the count of bike rental
      </BigTitle>
      <DefaultDiv>
        The primary objective of this project is to visualize various factors
        that are associated with bike rental rate and predict how these factors
        affect the count of total rentals.
      </DefaultDiv>
      <SemiTitle>This project uses data from Kaggle</SemiTitle>
      <div>
        <a
          target="_blank"
          href="https://www.kaggle.com/datasets/brajeshmohapatra/bike-count-prediction-data-set"
        >
      ...
      <MenuDiv>
        ...
        <div>
          - train.csv : Use this dataset to train the model. This dataset is
          comprised of first 18 months.
        </div>
        <div>
          - test.csv : Use the trained model to predict the count of total
          rentals for each hour during the next 6 months.
        </div>
      </MenuDiv>
      <MenuDiv>
        ...
        <div>
          - season: Type of season (1 = spring, 2 = summer, 3 = fall, 4 =
          winter)
        </div>
      ...
      <NumberTitle>
        {' '}
        1. Visualize and compare the bike usage by year, month and hour.
      </NumberTitle>
      ...
      <DefaultDiv>
        ...
        <div>
          - The monthly rental volume is highest in June and July, while it is
          lowest in January.
        </div>
        <div>
          - The hourly rental volume is highest in rush hours. If it's working
          day, the volume is different.
        </div>
      </DefaultDiv>

      <NumberTitle>
        {' '}
        2. Visualize the correlation between rental count and temperature,
      ...
      <DefaultDiv>
        <div>
          - It seems that there is no corelation between rental count and
          temperature, humidity and windspeed.
        </div>
        <div>
          - Some of the windspeeds are recorded as zero because it is not
          recorded.
        </div>
      </DefaultDiv>
      ...
      <NumberTitle>
        {' '}
        3. Remove outliers from windspeed data and make it follow normal
        distribution.
      </NumberTitle>
      ...
      <DefaultDiv>
        <div>
          - Without outliers, windspeed follows more nomralized patterns.
        </div>
        <div>
          - Data for training would be better if it follows normal districution.
        </div>
      </DefaultDiv>

      <SemiTitle>Train data and evaluate the model by RMSE</SemiTitle>
      ...
      <NumberTitle>
        {' '}
        2. Replace 0 recorded data in windSpeed column with random forest
        classifier
      </NumberTitle>
      <CodeBlock language="python" text={windSpeedDataCode} />
      <DefaultDiv>
        <div>
          - Rather than just removing 0 recorded data, replace that data with
          random forest classifier to make it more useful data.
        </div>
      ...
      <NumberTitle>
        {' '}
        3. Train and evaluate through KFold, RandomForestRegressor, and RMSE
      </NumberTitle>
